defmodule UtilityRunner do
  ...
  defp user_input_loop(user_input) do
    case user_input do
      "1" -> GuessingGame.start_game()
      "2" -> IO.gets("Please enter the path for the file to be analysed\n") |> FileAnalyzer.analyze()
      "0" -> IO.puts("Utility exited successfully.")
      _ -> user_input_loop(IO.gets("Please enter a valid option number.\n") |> String.trim)
    end
  end
end
